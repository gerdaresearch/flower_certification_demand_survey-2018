...
[調査票、単純集計表、回答者属性（匿名化）](https://github.com/gerdaresearch/flower_certification_demand_survey-2018/blob/main/Flower_certification_consumer_questionnaire_GT_FS_2018.xlsx)、ローデータ、報告書をリポジトリーに公開。  
